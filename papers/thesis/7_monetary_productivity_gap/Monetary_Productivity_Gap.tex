...
Financial assets---equities, bonds, real estate, commodities---are being represented as fractional tokens on public blockchains. BlackRock, the world's largest asset manager with \$10 trillion AUM, launched BUIDL---a tokenized US Treasury fund---on Ethereum, reaching \$500 million within months. Franklin Templeton runs an on-chain money market fund. JPMorgan's Onyx platform processes billions in tokenized repo transactions. The total value of tokenized real-world assets exceeded \$12 billion by late 2025, with Boston Consulting Group~\cite{bcg2022} projecting \$16 trillion by 2030. This is not speculative infrastructure being built by crypto startups---it is institutional infrastructure being built by the Mag 7 technology companies and the largest financial institutions on Earth.
...
This is amplified by a measurement problem that Kuznets~\cite{kuznets1934} anticipated: when AI drives more output at lower cost, GDP as conventionally measured \emph{falls} because prices decline. Central banks reading GDP-derived indicators see contraction and tighten further---but the contraction is phantom. True welfare is rising while measured GDP stagnates. This measurement error compounds the Lucas Gap into a systematic policy bias---the monetary analogue of the mismeasurement problems that plague agricultural productivity statistics in developing economies~\cite{gollin2014}.

\includegraphics[width=5.83333in,height=2.5in]{7_monetary_productivity_gap/media/f2bc0a0158573f21519f7de2a47c05580137cad5.png}
...
The model's central analytical result (Appendix, Proposition 1) is that network effects produce \emph{multiple equilibria}: a stable low-adoption equilibrium $\theta_l$, an unstable threshold $\theta^u$, and a stable high-adoption equilibrium $\theta_h$. The economy is trapped at $\theta_l$ because each agent's adoption decision depends on others' adoption through the network effect in transaction costs. The transition from $\theta_l$ to $\theta_h$ requires a discrete shock that pushes $\theta$ past the unstable threshold---the system has a \emph{cold-start problem}.
...
\includegraphics[width=5.41667in,height=3.07292in]{7_monetary_productivity_gap/media/64c3390efd39e8eeca3b609eec7aed9db2256814.png}
...
\emph{Sources: UN World Population Prospects 2024~\cite{un2024} (medium variant); World Bank WDI 2023~\cite{worldbank2023}.}

\textbf{4.1 The Demographic Fault Line}

The world is splitting along a demographic fault line that maps onto the monetary productivity gap. The Pre-Industrial and Early Industrial groups---2.9 billion people---have median ages of 18--26, fertility above 2.5, and fiat quality below 0.56. In the language of Galor's~\cite{galor2011} unified growth theory, as presented in Koyama and Rubin~\cite{koyama2022}, these populations have not completed the demographic transition from quantity to quality of children. They are still \emph{growing} through 2100. The Mid-Industrial and Post-Industrial groups---2.7 billion---are \emph{shrinking}, with median ages above 36 and sub-replacement fertility.
...
\includegraphics[width=5.83333in,height=2.60417in]{7_monetary_productivity_gap/media/64ac46d390ad09c4b4f2d8417589ba64cdb8dabe.png}
...
\textbf{Pre/Early Industrial (3 billion): leapfrogging adoption.} The monetary productivity gap is driven by fiat institutional failure, not AI demand. Young populations with high mobile penetration adopt stablecoins for savings and remittances. This echoes Gerschenkron's~\cite{gerschenkron1962} ``advantages of backwardness,'' which Koyama and Rubin~\cite{koyama2022} describe as ``certain economic advantages for countries that embarked upon industrialization from a more primitive starting point''---the ability to ``skip intermediary steps.'' Just as Kenya leapfrogged landlines for M-Pesa, Ethiopia need not build a full fiat banking system before adopting programmable money.
...
\includegraphics[width=5.83333in,height=2.60417in]{7_monetary_productivity_gap/media/ebd52323d54c407ca10610d1cbab1cdb652e4e30.png}
...
\bibitem{abadie2010}
Abadie, A., Diamond, A., \& Hainmueller, J. (2010). ``Synthetic Control Methods for Comparative Case Studies.'' \emph{Journal of the American Statistical Association} 105(490), 493--505.

\bibitem{bcg2022}
Boston Consulting Group (2022). ``Relevance of On-Chain Asset Tokenization in `Crypto Winter.'\,'' BCG and ADDX Research, September 2022.
...
\bibitem{coinbase2025}
Coinbase (2025). ``Payments MCP: Connecting AI to Crypto Payments.'' Coinbase Developer Platform Blog, October 23, 2025.

\bibitem{coinbase2026}
Coinbase (2026). ``Agentic Wallets: Give Any Agent a Wallet.'' Coinbase Developer Platform Blog, February 12, 2026.

\bibitem{galor2011}
Galor, O. (2011). \emph{Unified Growth Theory}. Princeton: Princeton University Press.

\bibitem{gautam2023}
Gautam, V. (2023). ``Impact Assessment of TDS on the Indian VDA Market.'' Esya Centre Special Issue No.\ 210.

\bibitem{gautam2024}
Gautam, V. \& Sharma, T. (2024). ``Taxes and Takedowns: An Assessment of India's Key Policy Tools for Virtual Digital Asset Markets.'' Esya Centre, June 2024.

\bibitem{gerschenkron1962}
Gerschenkron, A. (1962). \emph{Economic Backwardness in Historical Perspective}. Cambridge: Belknap Press.

\bibitem{gollin2014}
Gollin, D., Lagakos, D., \& Waugh, M. E. (2014). ``The Agricultural Productivity Gap.'' \emph{Quarterly Journal of Economics} 129(2), 939--993.

\bibitem{hsieh2009}
Hsieh, C.-T. \& Klenow, P. J. (2009). ``Misallocation and Manufacturing TFP in China and India.'' \emph{Quarterly Journal of Economics} 124(4), 1403--1448.

\bibitem{jack2014}
Jack, W. \& Suri, T. (2014). ``Risk Sharing and Transactions Costs: Evidence from Kenya's Mobile Money Revolution.'' \emph{American Economic Review} 104(1), 183--223.

\bibitem{king1993}
King, R. G. \& Levine, R. (1993). ``Finance and Growth: Schumpeter Might Be Right.'' \emph{Quarterly Journal of Economics} 108(3), 717--737.

\bibitem{koyama2022}
Koyama, M. \& Rubin, J. (2022). \emph{How the World Became Rich: The Historical Origins of Economic Growth}. Cambridge: Polity Press.

\bibitem{kuznets1934}
Kuznets, S. (1934). ``National Income, 1929--1932.'' 73rd U.S. Congress, 2d Session, Senate Document No.\ 124.

\bibitem{lucas1976}
Lucas, R. E. (1976). ``Econometric Policy Evaluation: A Critique.'' \emph{Carnegie-Rochester Conference Series} 1, 19--46.

\bibitem{pritchett1997}
Pritchett, L. (1997). ``Divergence, Big Time.'' \emph{Journal of Economic Perspectives} 11(3), 3--17.

\bibitem{rajan1998}
Rajan, R. G. \& Zingales, L. (1998). ``Financial Dependence and Growth.'' \emph{American Economic Review} 88(3), 559--586.
...
\bibitem{rochet2003}
Rochet, J.-C. \& Tirole, J. (2003). ``Platform Competition in Two-Sided Markets.'' \emph{Journal of the European Economic Association} 1(4), 990--1029.

\bibitem{solow1956}
Solow, R. M. (1956). ``A Contribution to the Theory of Economic Growth.'' \emph{Quarterly Journal of Economics} 70(1), 65--94.

\bibitem{un2024}
United Nations (2024). \emph{World Population Prospects 2024: Summary of Results}. UN DESA/POP/2024.

\bibitem{wissnergross2025}
Wissner-Gross, A. (2025). ``The AI Wealth Gap: Why 40x Deflation Changes Everything.'' \emph{Moonshots with Peter Diamandis}, Episode 208, November 17, 2025. Podcast.

\bibitem{worldbank2023}
World Bank (2023). \emph{World Development Indicators}. Washington, DC.
